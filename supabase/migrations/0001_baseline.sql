...
CREATE INDEX IF NOT EXISTS "idx_admin_roles_created_at" ON "public"."admin_roles" USING "btree" ("created_at" DESC);



CREATE INDEX IF NOT EXISTS "idx_audit_created_at" ON "public"."audit_logs" USING "btree" ("created_at" DESC);



CREATE INDEX IF NOT EXISTS "idx_changelog_published_at" ON "public"."changelog" USING "btree" ("published_at" DESC);
...
CREATE INDEX IF NOT EXISTS "idx_comment_reactions_visitor_id" ON "public"."comment_reactions" USING "btree" ("visitor_id");



CREATE INDEX IF NOT EXISTS "idx_comments_admin_heart" ON "public"."comments" USING "btree" ("admin_heart", "created_at" DESC);



CREATE INDEX IF NOT EXISTS "idx_comments_author_user_id" ON "public"."comments" USING "btree" ("author_user_id");



CREATE INDEX IF NOT EXISTS "idx_comments_edit_token_hash" ON "public"."comments" USING "btree" ("edit_token_hash");



CREATE INDEX IF NOT EXISTS "idx_comments_hidden_created_at" ON "public"."comments" USING "btree" ("is_hidden", "created_at" DESC);



CREATE INDEX IF NOT EXISTS "idx_comments_page_created_at" ON "public"."comments" USING "btree" ("page_key", "created_at" DESC);



CREATE INDEX IF NOT EXISTS "idx_reactions_comment" ON "public"."comment_reactions" USING "btree" ("comment_id");



CREATE INDEX IF NOT EXISTS "idx_reports_comment_created_at" ON "public"."comment_reports" USING "btree" ("comment_id", "created_at" DESC);



CREATE INDEX IF NOT EXISTS "idx_site_changelog_date" ON "public"."site_changelog" USING "btree" ("date" DESC, "created_at" DESC);



CREATE INDEX IF NOT EXISTS "idx_visits_page_visited_at" ON "public"."page_visits" USING "btree" ("page_key", "visited_at" DESC);



CREATE INDEX IF NOT EXISTS "idx_visits_visitor_visited_at" ON "public"."page_visits" USING "btree" ("visitor_hash", "visited_at" DESC);



CREATE UNIQUE INDEX IF NOT EXISTS "uq_reactions_admin_heart_one" ON "public"."comment_reactions" USING "btree" ("comment_id", "reaction_type") WHERE ("reaction_type" = 'admin_heart'::"text");



CREATE UNIQUE INDEX IF NOT EXISTS "uq_reactions_guest_per_comment_type" ON "public"."comment_reactions" USING "btree" ("comment_id", "reaction_type", "actor_fingerprint") WHERE (("actor_fingerprint" IS NOT NULL) AND ("reaction_type" = ANY (ARRAY['good'::"text", 'not_good'::"text"])));



CREATE UNIQUE INDEX IF NOT EXISTS "uq_reactions_user_per_comment_type" ON "public"."comment_reactions" USING "btree" ("comment_id", "reaction_type", "actor_user_id") WHERE (("actor_user_id" IS NOT NULL) AND ("reaction_type" = ANY (ARRAY['good'::"text", 'not_good'::"text"])));



CREATE UNIQUE INDEX IF NOT EXISTS "uq_reports_guest_once" ON "public"."comment_reports" USING "btree" ("comment_id", "guest_fingerprint") WHERE ("guest_fingerprint" IS NOT NULL);



CREATE UNIQUE INDEX IF NOT EXISTS "uq_reports_user_once" ON "public"."comment_reports" USING "btree" ("comment_id", "reporter_user_id") WHERE ("reporter_user_id" IS NOT NULL);
...
DROP POLICY IF EXISTS "changelog_admin_write" ON "public"."changelog";
...
DROP POLICY IF EXISTS "changelog_select_public" ON "public"."changelog";
