...
export function HomeNotificationsSection({ items }: Props) {
  ...
  return (
    <section className="mb-10">
      ...
      <div className="mt-4 flex flex-wrap gap-4 text-sm">
        <Link href="/youtube" className="text-primary hover:underline">
          YouTube もっと見る →
        </Link>
        <Link href="/niconico" className="text-primary hover:underline">
          ニコニコ もっと見る →
        </Link>
      </div>
    </section>
